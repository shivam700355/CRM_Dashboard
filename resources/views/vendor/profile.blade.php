            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                  <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle" src="{{url('dist/img/avatar.png') }}"
                         alt="User profile picture">
                  </div>
                  <h3 class="profile-username text-center">User Profile</h3>
                  <!-- <p class="text-muted text-center">Banking Support</p> -->
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                      <b>Phone:</b> <a class="float-right">{{ Auth::user()->mobile }}</a>
                    </li>
                    <li class="list-group-item">
                      <b>Role: </b> <a class="float-right">{{ Auth::user()->role?'Admin':'Employee' }}</a>
                    </li>
                  </ul>
