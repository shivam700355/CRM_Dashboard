        ...
        <div class="login">
            <div class="wrap">
                ...
                <div class="terms">
                    ...
                    <h3>Welcome to UFS DIGITAL LIMITED</h3>
                ...
                <div class="recovery">
                    ...
                    <p>If any Technical issue, Please call on <br>+91- 639-000-0205</p>
                    <form class="recovery-form" action="{{route('report_BOB')}}" method="GET" name="search">
                        <input type="text" class="input" id="search" name="search" placeholder="Search by KO Code & Ticket No." require>
                ...
                <!-- LOGO -->
                    <div class="logo">
                        <a href="#"><img src="{{ url('dist/img/vaa-logo.png') }}" alt=""></a>
                    </div>
                <!-- SLIDESHOW -->
                <div id="slideshow">
                    <div class="one">
                        <h2><span>COMMISSION</span></h2>
                        <p>Sign in to see BC Commissions of every months</p>
                    </div>
                    <div class="two">
                        <h2><span>QUERY</span></h2>
                        <p>Submit Technical Query for Banking Correspondent</p>
                    </div>
                    <div class="three">
                        <h2><span>STATUS</span></h2>
                        <p>Search status for Technical Query, If any Technical issue, Please call on <br>
    +91-639-000-0205</p>
                    </div>
                    <div class="four">
                        <h2><span>BANKING</span></h2>
                        <p>Sign in to access Banking details</p>
                    </div>
                </div>
                </div>
                <!-- LOGIN FORM -->
                <div class="user">
                    ...
                    <div class="form-wrap">
                    	...
                    	<div class="tabs">
                    		...
                    		<h3 class="signup-tab"><a class="sign-up" href="#signup-tab-content"><span>Submit Query</span></a></h3>
                    	</div>
                        <!-- TABS CONTENT -->
                		...
                		<div id="login-tab-content" class="active">
                			...
                			<!-- <form class="login-form" action="" method="post"> -->
                				<input type="email" class="input" id="email" name="email" autocomplete="off" placeholder="Email or Username">
                                <input type="password" id="password" name="password" class="input" autocomplete="off" placeholder="Password">
            			...
            			<form class="signup-form" action="{{ route('save') }}" method="post" enctype="multipart/form-data">
                        @csrf
            				<input type="text" class="input" id="ko_code" name="ko_code" placeholder="Enter ko_code" require>
            				<!-- <span class="input" id="issue"> -->
            				<select id="issue" type="text" class="input demo" style="color: black;" name="issue">
                              <option value="">Select</option>
                              <option style="color: black;" value="Login Issue">Login Issue</option>
                              <option style="color: black;" value="Software Installation">Software Installation</option>
            				...
            				<!-- <input type="submit" class="button" value="Submit Query"> -->
            			</form><br>
                            <div class="help-action">
                                <p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="forgot" href="#">Search status by KO Code ?</a></p>
                            </div>
                			<!-- <div class="help-action">
